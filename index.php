		...
		<div id="associationModal" class="modal">
			<div class="w-full max-w-7xl mx-auto p-6 my-12">
				<div class="modal-content rounded-3xl p-10 relative max-w-7xl mx-auto">
					...
					<!-- Title -->
					<h2 class="xl:text-5xl font-bold text-tarawera mb-12 text-center">ASSOCIATION</h2>
					<!-- President's Message -->
					<div class="mb-16">
						<h3 class="xl:text-3xl font-bold text-jelly-bean mb-4">MOT DU PRÉSIDENT</h3>
					...
					<!-- Who We Are -->
					<div class="mb-16">
						<h3 class="xl:text-3xl font-bold text-jelly-bean mb-4">QUI SOMMES-NOUS?</h3>
					...
					<!-- Staff -->
					<div>
						<h3 class="xl:text-3xl font-bold text-jelly-bean mb-8 text-center">STAFF</h3>
		...
		<div id="evenementsModal" class="modal">
			<div class="w-full max-w-7xl mx-auto p-8 my-8">
				<div class="modal-content bg-white rounded-2xl shadow-2xl p-12 relative max-w-7xl mx-auto">
					...
					<!-- Title -->
					<h2 class="xl:text-5xl font-bold text-tarawera mb-12 text-center">ÉVÈNEMENTS</h2>
					<!-- Events Grid -->
					<div class="space-y-8">
						...
						<div class="border-l-4 border-jelly-bean pl-6 hover:shadow-xl transition-shadow duration-300 p-6 rounded-r-xl bg-gradient-to-r from-nebula/20 to-transparent">
							<div class="flex items-start justify-between mb-3">
								<div>
									<span class="inline-block bg-jelly-bean text-white text-xs font-bold px-3 py-1 rounded-full mb-2">À VENIR</span>
									<a href="https://karkouri-zakaria.github.io/casicam/" target="_blank" rel="noopener" class="xl:text-2xl font-bold text-tarawera mb-2 hover:text-jelly-bean transition-colors">CASABLANCA INTERNATIONAL CONFERENCE ON ADDITIVE MANUFACTURING 2026</a>
						...
						<div class="border-l-4 border-tarawera pl-6 hover:shadow-lg transition-shadow duration-300 p-6 rounded-r-xl">
							<div class="flex items-start justify-between mb-3">
								<div>
									...
									<a href="https://www.casicam.com/" target="_blank" rel="noopener" class="xl:text-2xl font-bold text-tarawera mb-2 hover:text-jelly-bean transition-colors">CASABLANCA INTERNATIONAL CONFERENCE ON ADDITIVE MANUFACTURING</a>
						...
						<div class="border-l-4 border-tarawera pl-6 hover:shadow-lg transition-shadow duration-300 p-6 rounded-r-xl">
							<div class="flex items-start justify-between mb-3">
								<div>
									<span class="inline-block bg-gray-500 text-white text-xs font-bold px-3 py-1 rounded-full mb-2">PASSÉ</span>
									<a href="https://http://amfaim3d.org/casablanca-international-conference-on-additive-manufacturing-november-23-24-2022-morocco/" target="_blank" rel="noopener" class="xl:text-2xl font-bold text-tarawera mb-2 hover:text-jelly-bean transition-colors">CASABLANCA INTERNATIONAL CONFERENCE ON ADDITIVE MANUFACTURING</a>
						...
						<div class="border-l-4 border-tarawera pl-6 hover:shadow-lg transition-shadow duration-300 p-6 rounded-r-xl">
							<div class="mb-3">
								<span class="inline-block bg-gray-500 text-white text-xs font-bold px-3 py-1 rounded-full mb-2">PASSÉ</span>
								<a href="http://amfaim3d.org/donec-luctus-imperdiet/" target="_blank" rel="noopener" class="xl:text-2xl font-bold text-tarawera mb-2 hover:text-jelly-bean transition-colors">CASABLANCA INTERNATIONAL CONFERENCE ON ADDITIVE MANUFACTURING</a>
						...
						<div class="border-l-4 border-tarawera pl-6 hover:shadow-lg transition-shadow duration-300 p-6 rounded-r-xl">
							<div class="mb-3">
								<span class="inline-block bg-amber-500 text-white text-xs font-bold px-3 py-1 rounded-full mb-2">ÉPINGLÉ</span>
								<a href="http://amfaim3d.org/mw3dp2019/" target="_blank" rel="noopener" class="xl:text-2xl font-bold text-tarawera mb-2 hover:text-jelly-bean transition-colors">MOROCCAN WORKSHOP ON 3D PRINTING (MW3DP 2019)</a>
						...
						<div class="border-l-4 border-tarawera pl-6 hover:shadow-lg transition-shadow duration-300 p-6 rounded-r-xl">
							<div class="mb-3">
								<span class="inline-block bg-amber-500 text-white text-xs font-bold px-3 py-1 rounded-full mb-2">ÉPINGLÉ</span>
								<a href="http://amfaim3d.org/donec-luctus-imperdiet-2/" target="_blank" rel="noopener" class="xl:text-2xl font-bold text-tarawera mb-2 hover:text-jelly-bean transition-colors">CÉRÉMONIE D'INAUGURATION (AMFAIM3D)</a>
								<p class="text-jelly-bean font-semibold">December 18, 2019 | Morocco</p>
		...
		<div id="sponsorsModal" class="modal">
			<div class="w-full max-w-7xl mx-auto p-8 my-8">
				<div class="modal-content bg-white rounded-2xl shadow-2xl p-12 relative max-w-7xl mx-auto">
					...
					<!-- Title -->
					<h2 class="xl:text-5xl font-bold text-tarawera mb-4 text-center">NOS PARTENAIRES</h2>
		...
		<div id="contactModal" class="modal">
			<div class="w-full max-w-7xl mx-auto p-8 my-8">
				<div class="modal-content bg-white rounded-2xl shadow-2xl p-12 relative max-w-7xl mx-auto">
					...
					<!-- Title -->
					<h2 class="xl:text-5xl font-bold text-tarawera mb-4 text-center">CONTACT</h2>
